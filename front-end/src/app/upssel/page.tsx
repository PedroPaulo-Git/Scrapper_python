...
const Congratulations = () => {
  ...
  return (
    <div className="flex flex-col  mb-28 text-white items-center max-w-[450px] w-full px-2 mx-auto overflow-x-hidden ">
      ...
      <div
        className="mt-4 text-4xl text-red-500 font-semibold "
      >
        ATTENTION
      </div>
...
<p className="text-sm text-center mt-4 text-red-600 font-semibold">
  ⚠️ This is your only chance to stay anonymous.<br />
  If you leave now, <u>@{username}</u> may be notified of your tracking attempt.
</p>
